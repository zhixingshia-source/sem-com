...
class SetokTokenizer(nn.Module):
    def __init__(self, 
        ...
        # Align to CLIPVisionTower API (model_name, unfreeze, use_fp16)
        self.image_feature_encoder = CLIPVisionTower(
            model_name=vision_tower,
            unfreeze=bool(unfreeze_mm_vision_tower),
            use_fp16=True,
        )
    ...
    @property
    def dtype(self):
        # return dtype of a representative parameter
    ...
    def forward(self, x, k=None, threshold=None, token_mask=None):
        ...
        pos_emb = self.position_embedding(h, w)
