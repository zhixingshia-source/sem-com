...
class CLIPTokenizer(PreTrainedTokenizer):
    ...
    def get_vocab(self):
    # Universal compatibility for different HF versions
        if hasattr(self, "encoder"):  # old version
            vocab = self.encoder
        elif hasattr(self, "vocab"):  # mid version
            vocab = self.vocab
        elif hasattr(self, "get_vocab_dict"):  # new versions ≥4.35
            vocab = self.get_vocab_dict()
        elif hasattr(self, "_tokenizer"):  # very new versions (≥4.40)
            # fallback for fast tokenizers
            try:
            ...
            vocab = {}
        return dict(vocab, **getattr(self, "added_tokens_encoder", {}))
